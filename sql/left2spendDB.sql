...
SHOW WARNINGS;
CREATE INDEX `FK_users_account_id_idx` ON `users` (`account_id` ASC);
...
START TRANSACTION;
USE `left2spenddb`;
INSERT INTO `users` (`email`, `amount_spent`, `password`, `account_id`) VALUES ('jeffrey.leupp@gmail.com', 0, 'rowcol', 1);
INSERT INTO `users` (`email`, `amount_spent`, `password`, `account_id`) VALUES ('elenapignatelli@gmail.com', 0, 'pipe', 1);
INSERT INTO `users` (`email`, `amount_spent`, `password`, `account_id`) VALUES ('docmeow@mail.com', 0, 'meow', 2);
